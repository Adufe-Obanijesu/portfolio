...
const Contact = () => {
    return (
        <section id="contact" className="md:py-16 py-10">
            <Hoc><p className="smallHeading">get in touch</p></Hoc>
        
            <Hoc><h3 className="heading">contact</h3></Hoc>
            
            <Hoc><p className="lg:mt-16 mt-10">
                Impressed with my work & skills? Want to work with me? You can reach out to me through the social media handles below or you can simply give me a call  <BiSolidPhone className="inline" />.
            </p></Hoc>
