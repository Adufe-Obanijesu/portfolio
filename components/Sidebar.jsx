    ...
    return (
        <aside className={`overflow-hidden bg-gray-100 px-12 py-10 h-full fixed ${show ? "block" : "hidden"} w-3/4 shadow md:shadow-none md:w-auto md:block z-20`}>
            ...
            <div className="flex justify-center">
                <Image src={profilePic} className="rounded-full lg:h-40 md:h-32 lg:w-40 md:w-32 object-cover" alt="profile pic" />
            </div>
            <div className="mt-8">
                <h3 className="text-2xl font-bold text-center mb-2 tracking-normal">Adufe Obanijesu</h3>
