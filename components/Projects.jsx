...
const Projects = () => {
	return (
        ...
        <div className="grid md:grid-cols-2 grid-cols-1 gap-8 mt-8">
        	...
        	<Hoc><a target="_blank" href="https://www.kadoshmechatronics.com"><div className="shadow-md shadow-slate-800 h-full flex flex-col">
        		<Image src={kadosh} className="object-cover w-full" alt="project" />
        	...
        	<Hoc><a target="_blank" href="https://cheerful-wisp-6f1261.netlify.app/"><div className="shadow-md shadow-slate-800">
        		<Image src={hotel} className="object-cover w-full" alt="project" />
        		<div className="p-4">
        	...
        	<Hoc><a target="_blank" href="https://calm-semifreddo-77a271.netlify.app/"><div className="shadow-md shadow-slate-800">
        		<Image src={restaurant} className="object-cover w-full" alt="project" />
        		<div className="p-4">
        	...
        	<Hoc><a target="_blank" href="https://loquacious-mochi-5aa671.netlify.app/"><div className="shadow-md shadow-slate-800">
            ...
            <Hoc><a target="_blank" href="https://phenomenal-cannoli-d81bdf.netlify.app/"><div className="shadow-md shadow-slate-800">
