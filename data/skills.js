...
export const skills = [
  ...
  {
    icon: <FaCss3 className="text-white text-5xl" />,
    bg: "bg-blue-400",
    label: "CSS3",
  },
  // { icon: <FaSass className="text-white text-5xl" />, bg: "bg-pink-500", label: "Sass" },
  {
    icon: <BiLogoTailwindCss className="text-white text-5xl" />,
    bg: "bg-blue-400",
    label: "TailwindCSS",
  },
  {
  ...
  {
    icon: <IoAccessibility className="text-white text-5xl" />,
    bg: "bg-orange-400",
    label: "Accessibility",
  },
  {
    icon: <DiJavascript1 className="text-white text-5xl" />,
    bg: "bg-yellow-400",
    label: "JavaScript",
  },
  {
  ...
  {
    icon: <SiFirebase className="text-white text-5xl" />,
    bg: "bg-yellow-400",
    label: "Firebase",
  },
  {
    icon: <FaFigma className="text-white text-5xl" />,
    bg: "bg-red-400",
    label: "Figma",
  },
  {
  ...
  {
    icon: <SiExpress className="text-slate-900 text-5xl" />,
    bg: "bg-slate-100",
    label: "Express.js",
  },
  {
    icon: <SiMongodb className="text-white text-5xl" />,
    bg: "bg-green-400",
    label: "MongoDB",
  },
  {
    icon: <SiPhp className="text-white text-5xl" />,
    bg: "bg-purple-500",
    label: "PHP",
  },
  {
  ...
  {
    icon: <BsGit className="text-white text-5xl" />,
    bg: "bg-orange-600",
    label: "Git",
  },
  {
    icon: <AiFillGithub className="text-white text-5xl" />,
    bg: "bg-black",
    label: "Github",
  },
];
